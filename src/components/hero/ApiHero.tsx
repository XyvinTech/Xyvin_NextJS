    ...
    return (
        <>
            ...
            <div style={{ backgroundImage: `url(${Bg.src})` }}
                className=' w-full h-[700px] lg:h-screen bg-[url("/assets/img/seo_bg.svg")] bg-cover bg-no-repeat bg-right'>
                <div className=' container flex flex-col lg:flex-row justify-center h-full items-center'>
                    <div className=' lg:flex-1 flex flex-col gap-20 lg:gap-32'>
                        <div>
                            ...
                            <h1 className=' font-bold font-inter text-4xl m-0 lg:w-[1000px] lg:text-6xl'>
                                API Integration and Consultation Services
                            </h1>
